...
describe('AlphagovAccessibleAutocompleteComponent', () => {
  ...
  it('should apply describedby on changes to hint or error inputs', () => {
    ...
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    vi.spyOn(component as any, 'applyDescribedBy');
  ...
  it('should handle on confirm and input should be marked as dirty', () => {
    ...
    vi.spyOn(document, 'querySelector').mockReturnValue(mockInputElement);
    ...
    expect(component['_control'].pristine).not.toBe(true);
    expect(component['_control'].dirty).toBe(true);

    expect(component['_control'].valid).toBe(true);
  ...
  it('should not clear the autocomplete as we have a value', () => {
    ...
    vi.spyOn(componentWithPrivates, 'configureAutoComplete');
    ...
    expect(componentWithPrivates.configureAutoComplete).not.toHaveBeenCalled();
  });
  ...
  it('should clear autocomplete when control value changes to null', () => {
    ...
    expect(componentWithPrivates.configureAutoComplete).toHaveBeenCalled();
  ...
  it('it should test the onConfirm section of buildAutoCompleteProps', () => {
    ...
    if (typeof autoCompleteProps.onConfirm === 'function') {
      ...
      vi.spyOn(component as unknown as PrivateFunctionsComponent, 'handleOnConfirm');
