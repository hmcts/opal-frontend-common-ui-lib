...
import { CustomAccessibleMonetaryComponent } from './custom-accessible-monetary.component';

describe('CustomAccessibleMonetaryComponent', () => {
  let fixture: ComponentFixture<CustomAccessibleMonetaryComponent>;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(CustomAccessibleMonetaryComponent);
  });
